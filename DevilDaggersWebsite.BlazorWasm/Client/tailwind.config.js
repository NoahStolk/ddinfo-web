	...
	theme: {
		extend: {
			...
			gridTemplateColumns: {
				...
				'custom-leaderboard-xl': createMinmaxGrid([4, 3, 1, 2, 1, 1, 1, 1, 1, 3, 1]),
				'custom-leaderboard-lg': createMinmaxGrid([4, 3, 1, 2, 3, 1]),
				'custom-leaderboard-md': createMinmaxGrid([4, 3, 1, 2]),
