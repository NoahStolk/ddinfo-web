...
// 			Vector2 start = ArenaEditingUtils.Snap(_pencilStart.Value.ToVector2(), ArenaChild.TileSize) + ArenaChild.HalfTileAsVector2;
// 			Vector2 end = ArenaEditingUtils.Snap(pencilEnd.ToVector2(), ArenaChild.TileSize) + ArenaChild.HalfTileAsVector2;
...
// 						continue;
//
// 					Vector2 visualTileCenter = new Vector2(i, j) * ArenaChild.TileSize + ArenaChild.HalfTile.ToVector2();
//
...
// 					Root.Game.RectangleRenderer.Schedule(new(ArenaChild.TileSize), origin + new Vector2i<int>(i, j) * ArenaChild.TileSize + ArenaChild.HalfTile, depth, Color.HalfTransparentWhite);
// 			}
// 		}
// 	}
//
...
// 	{
// 		return ArenaEditingUtils.Snap(position, ArenaChild.TileSize) + ArenaChild.HalfTile;
// 	}
// }
