...
public class MainLayout : Layout, IMainLayout
{
	...
	public MainLayout()
	{
		...
		AddButton(0, 0, Color.FromHsv(000, 1, 0.8f), BaseStateManager.ToSurvivalEditorMainLayout, "Survival Editor");
		...
		AddButton(0, 3, Color.Gray(0.3f), BaseStateManager.ToConfigLayout, "Configuration");
