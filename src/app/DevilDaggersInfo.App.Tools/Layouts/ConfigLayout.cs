...
public class ConfigLayout : Layout, IConfigLayout
{
		...
		: base(Constants.Full)
	{
		...
		NestingContext.Add(new Button(Rectangle.At(32, 320, 256, 32), Check, Color.Black, Color.White, Color.Gray(0.25f), Color.White, "Save and continue", TextAlign.Middle, 2, FontSize.F8X8));
	}
