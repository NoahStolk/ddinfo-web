...
public class SurvivalEditorSaveLayout : Layout, IFileDialogLayout
{
		...
		: base(Constants.Full)
	{
		...
		Button saveButton = new(Rectangle.At(512, 48, 128, 16), () => SaveSpawnset(Path.Combine(_pathTextInput.Value.ToString(), fileTextInput.Value.ToString())), Color.Black, Color.White, Color.White, Color.Red, "Save", TextAlign.Left, 0, FontSize.F8X8);
