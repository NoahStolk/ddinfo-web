...
public static class ComponentBuilder
{
	...
	{
		return new(rectangle, isNumeric, onEnter, onDeselect, onInput, Color.Black, Color.Gray(0.75f), Color.Gray(0.25f), Color.White, Color.White, Color.Green, Color.Gray(0.5f), 2, FontSize.F8X8, 8, 4);
	}
}
