...
internal static class CustomLeaderboardConverters
{
	...
	private static ToolsApi.CustomLeaderboardCriteriaType ToToolsApi(this CustomLeaderboardCriteriaType criteriaType)
	{
		return criteriaType switch
		{
			...
			CustomLeaderboardCriteriaType.Skull1Kills => ToolsApi.CustomLeaderboardCriteriaType.Skull1KillCount,
			CustomLeaderboardCriteriaType.Skull2Kills => ToolsApi.CustomLeaderboardCriteriaType.Skull2KillCount,
			CustomLeaderboardCriteriaType.Skull3Kills => ToolsApi.CustomLeaderboardCriteriaType.Skull3KillCount,
			CustomLeaderboardCriteriaType.Skull4Kills => ToolsApi.CustomLeaderboardCriteriaType.Skull4KillCount,
			CustomLeaderboardCriteriaType.SpiderlingKills => ToolsApi.CustomLeaderboardCriteriaType.SpiderlingKillCount,
			CustomLeaderboardCriteriaType.SpiderEggKills => ToolsApi.CustomLeaderboardCriteriaType.SpiderEggKillCount,
			CustomLeaderboardCriteriaType.Squid1Kills => ToolsApi.CustomLeaderboardCriteriaType.Squid1KillCount,
			CustomLeaderboardCriteriaType.Squid2Kills => ToolsApi.CustomLeaderboardCriteriaType.Squid2KillCount,
			CustomLeaderboardCriteriaType.Squid3Kills => ToolsApi.CustomLeaderboardCriteriaType.Squid3KillCount,
			CustomLeaderboardCriteriaType.CentipedeKills => ToolsApi.CustomLeaderboardCriteriaType.CentipedeKillCount,
			CustomLeaderboardCriteriaType.GigapedeKills => ToolsApi.CustomLeaderboardCriteriaType.GigapedeKillCount,
			CustomLeaderboardCriteriaType.GhostpedeKills => ToolsApi.CustomLeaderboardCriteriaType.GhostpedeKillCount,
			CustomLeaderboardCriteriaType.Spider1Kills => ToolsApi.CustomLeaderboardCriteriaType.Spider1KillCount,
			CustomLeaderboardCriteriaType.Spider2Kills => ToolsApi.CustomLeaderboardCriteriaType.Spider2KillCount,
			CustomLeaderboardCriteriaType.LeviathanKills => ToolsApi.CustomLeaderboardCriteriaType.LeviathanKillCount,
			CustomLeaderboardCriteriaType.OrbKills => ToolsApi.CustomLeaderboardCriteriaType.OrbKillCount,
			CustomLeaderboardCriteriaType.ThornKills => ToolsApi.CustomLeaderboardCriteriaType.ThornKillCount,
			CustomLeaderboardCriteriaType.Skull1sAlive => ToolsApi.CustomLeaderboardCriteriaType.Skull1AliveCount,
			CustomLeaderboardCriteriaType.Skull2sAlive => ToolsApi.CustomLeaderboardCriteriaType.Skull2AliveCount,
			CustomLeaderboardCriteriaType.Skull3sAlive => ToolsApi.CustomLeaderboardCriteriaType.Skull3AliveCount,
			CustomLeaderboardCriteriaType.Skull4sAlive => ToolsApi.CustomLeaderboardCriteriaType.Skull4AliveCount,
			CustomLeaderboardCriteriaType.SpiderlingsAlive => ToolsApi.CustomLeaderboardCriteriaType.SpiderlingAliveCount,
			CustomLeaderboardCriteriaType.SpiderEggsAlive => ToolsApi.CustomLeaderboardCriteriaType.SpiderEggAliveCount,
			CustomLeaderboardCriteriaType.Squid1sAlive => ToolsApi.CustomLeaderboardCriteriaType.Squid1AliveCount,
			CustomLeaderboardCriteriaType.Squid2sAlive => ToolsApi.CustomLeaderboardCriteriaType.Squid2AliveCount,
			CustomLeaderboardCriteriaType.Squid3sAlive => ToolsApi.CustomLeaderboardCriteriaType.Squid3AliveCount,
			CustomLeaderboardCriteriaType.CentipedesAlive => ToolsApi.CustomLeaderboardCriteriaType.CentipedeAliveCount,
			CustomLeaderboardCriteriaType.GigapedesAlive => ToolsApi.CustomLeaderboardCriteriaType.GigapedeAliveCount,
			CustomLeaderboardCriteriaType.GhostpedesAlive => ToolsApi.CustomLeaderboardCriteriaType.GhostpedeAliveCount,
			CustomLeaderboardCriteriaType.Spider1sAlive => ToolsApi.CustomLeaderboardCriteriaType.Spider1AliveCount,
			CustomLeaderboardCriteriaType.Spider2sAlive => ToolsApi.CustomLeaderboardCriteriaType.Spider2AliveCount,
			CustomLeaderboardCriteriaType.LeviathansAlive => ToolsApi.CustomLeaderboardCriteriaType.LeviathanAliveCount,
			CustomLeaderboardCriteriaType.OrbsAlive => ToolsApi.CustomLeaderboardCriteriaType.OrbAliveCount,
			CustomLeaderboardCriteriaType.ThornsAlive => ToolsApi.CustomLeaderboardCriteriaType.ThornAliveCount,
