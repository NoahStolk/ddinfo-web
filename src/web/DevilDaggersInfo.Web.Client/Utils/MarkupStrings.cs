...
public static class MarkupStrings
{
	...
	public static readonly MarkupString NavStart = new($"""
		<svg style='margin: {_margin}px;' width='{_size}' height='{_size}'>
		...
		""");
	public static readonly MarkupString NavPrevDouble = new($"""
		<svg style='margin: {_margin}px;' width='{_size}' height='{_size}'>
			<polygon points='{_a},{_m} {_m},{_a} {_m},{_b}' style='fill: {_fillStyle};' />
			<polygon points='{_m},{_m} {_b},{_a} {_b},{_b}' style='fill: {_fillStyle};' />
		</svg>
		""");
	public static readonly MarkupString NavPrev = new($"""
		<svg style='margin: {_margin}px;' width='{_size}' height='{_size}'>
			<polygon points='{_am},{_m} {_bm},{_a} {_bm},{_b}' style='fill: {_fillStyle};' />
		</svg>
		""");
	public static readonly MarkupString NavNext = new($"""
		<svg style='margin: {_margin}px;' width='{_size}' height='{_size}'>
			<polygon points='{_am},{_a} {_am},{_b} {_bm},{_m}' style='fill: {_fillStyle};' />
		</svg>
		""");
	public static readonly MarkupString NavNextDouble = new($"""
		<svg style='margin: {_margin}px;' width='{_size}' height='{_size}'>
			<polygon points='{_a},{_a} {_a},{_b} {_m},{_m}' style='fill: {_fillStyle};' />
			<polygon points='{_m},{_a} {_m},{_b} {_b},{_m}' style='fill: {_fillStyle};' />
		</svg>
		""");
	public static readonly MarkupString NavEnd = new($"""
		<svg style='margin: {_margin}px;' width='{_size}' height='{_size}'>
			<polygon points='{_a},{_a} {_a},{_b} {_m},{_m}' style='fill: {_fillStyle};' />
			<polygon points='{_m},{_a} {_m},{_b} {_b},{_m}' style='fill: {_fillStyle};' />
	...
	public static readonly MarkupString Checkmark = new("""
		<svg style='margin: 3px;' width='28' height='28'>
