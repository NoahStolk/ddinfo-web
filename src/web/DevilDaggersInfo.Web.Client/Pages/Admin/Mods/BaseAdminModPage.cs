...
{
	protected IReadOnlyDictionary<int, string> ModTypes { get; } = Enum.GetValues<ModTypes>().Where(mt => mt != ApiSpec.Admin.Mods.ModTypes.None).ToDictionary(e => (int)e, e => e.ToString());
