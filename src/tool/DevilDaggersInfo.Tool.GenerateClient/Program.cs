...
new HttpClientSourceGenerator("Ddcl", "DevilDaggersInfo.Core.CustomLeaderboard.HttpClients", "DdclApiHttpClient", Path.Combine(Constants.CoreClProjectPath, "HttpClients", "DdclApiHttpClientGenerated.cs")).Execute();
