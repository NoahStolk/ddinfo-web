...
new HttpClientSourceGenerator("App", "DevilDaggersInfo.App.Ui.Base.Networking", "AppApiHttpClient", Path.Combine(Constants.ToolsProjectPath, "Networking", "AppApiHttpClientGenerated.cs")).Execute();
