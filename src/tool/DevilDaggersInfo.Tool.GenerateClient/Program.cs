...
new HttpClientSourceGenerator("App", "DevilDaggersInfo.App.Core.ApiClient", "AppApiHttpClient", Path.Combine(Constants.ToolsProjectPath, "AppApiHttpClientGenerated.cs")).Execute();
