...
public static class EnemyDescriptions
{
	private static readonly Dictionary<Enemy, string[]> _enemyDescriptions = new()
	{
		...
		{ EnemiesV1_0.Skull2, new[] { "Repeatedly moves towards a random position for between 1.6 and 2.5 seconds" } },
		{ EnemiesV1_0.Skull3, new[] { "Chases the player fast" } },
		{ EnemiesV1_0.TransmutedSkull2, new[] { "Repeatedly moves towards a random position for between 1.6 and 2.5 seconds" } },
		...
		{ EnemiesV2_0.Skull2, new[] { "Repeatedly moves towards a random position for between 1.6 and 2.5 seconds" } },
		...
		{ EnemiesV2_0.TransmutedSkull2, new[] { "Repeatedly moves towards a random position for between 1.6 and 2.5 seconds" } },
		...
		{ EnemiesV2_0.Andras, new[] { "Unfinished enemy that was never added to the real game", "Only appears in V2, can only be spawned using an edited spawnset", "Has its own sounds", "Uses the mesh for Skull III, but is smaller in size", "Does nothing but attract and consume all homing daggers like Ghostpede ", "Only takes damage when shot from above, so the player will need to daggerjump", "The player doesn't die when touching it" } },
		...
		{ EnemiesV3_0.Skull2, new[] { "Repeatedly moves towards a random position for between 1.6 and 2.5 seconds" } },
		...
		{ EnemiesV3_0.TransmutedSkull2, new[] { "Repeatedly moves towards a random position for between 1.6 and 2.5 seconds" } },
		...
		{ EnemiesV3_1.Centipede, new[] { "Emerges approximately 3 seconds after its spawn, starts flying idly for a while, then starts chasing the player", "Burrows after 15 seconds of being emerged, or if the player gets too close to its head" } },
		...
		{ EnemiesV3_1.Skull2, new[] { "Repeatedly moves towards a random position for between 1.6 and 2.5 seconds" } },
		...
		{ EnemiesV3_1.TransmutedSkull2, new[] { "Repeatedly moves towards a random position for between 1.6 and 2.5 seconds" } },
		...
		{ EnemiesV3_2.Squid1, new[] { "Spawns at the edge of the arena", "Moves slowly and rotates clockwise", "Spawns 10 Skull Is and 1 Skull II every 20 seconds (starting 3 seconds after its initial appearance)" } },
		{ EnemiesV3_2.Squid2, new[] { "Spawns at the edge of the arena", "Moves slowly and rotates clockwise", "Spawns 10 Skull Is and 1 Skull III every 20 seconds (starting 3 seconds after its initial appearance)" } },
		{ EnemiesV3_2.Squid3, new[] { "Spawns at the edge of the arena", "Moves slowly and rotates clockwise", "Spawns 15 Skull Is and 1 Skull IV every 20 seconds (starting 3 seconds after its initial appearance)" } },
		{ EnemiesV3_2.Centipede, new[] { "Emerges approximately 3 seconds after its spawn, starts flying idly for a while, then starts chasing the player", "Burrows after 15 seconds of being emerged, or if the player gets too close to its head" } },
		{ EnemiesV3_2.Gigapede, new[] { "Emerges approximately 3 seconds after its spawn, then starts chasing the player immediately" } },
		{ EnemiesV3_2.Ghostpede, new[] { "Emerges approximately 3 seconds after its spawn, then starts flying in circles high above the arena", "Attracts and consumes all homing daggers, making them useless" } },
		{ EnemiesV3_2.Leviathan, new[] { "Activates 8.5333 seconds after its initial appearance", "Attracts and transmutes all skulls by beckoning every 20 seconds, starting 13.5333 seconds after its spawn (5 seconds after becoming active)", "Rotates counter-clockwise", "Drops The Orb 3.3167 seconds after dying" } },
		{ EnemiesV3_2.Thorn, new[] { "Emerges approximately 3 seconds after its spawn", "Takes up space" } },
		{ EnemiesV3_2.Spider1, new[] { "Spawns at the edge of the arena and starts lifting its head, faces the player after 3 seconds", "Attracts and consumes gems when facing the player, ejecting them as Spider Egg I one at a time", "Hides its head when shot and left unharmed for 1 second", "Begins moving randomly in an unpredictable jittery fashion after initially raising its head" } },
		{ EnemiesV3_2.Spider2, new[] { "Spawns at the edge of the arena and starts lifting its head, faces the player after 9 seconds", "Attracts and consumes gems when facing the player, ejecting them as Spider Egg II one at a time", "Hides its head when shot and left unharmed for 1 second", "Begins moving randomly in an unpredictable jittery fashion after initially raising its head (though barely noticeable due to its size)" } },
		{ EnemiesV3_2.Skull1, new[] { "Slowly chases the player" } },
		{ EnemiesV3_2.Skull2, new[] { "Repeatedly moves towards a random position for between 1.6 and 2.5 seconds" } },
		{ EnemiesV3_2.Skull3, new[] { "Chases the player fast" } },
		{ EnemiesV3_2.Skull4, new[] { "Chases the player fast" } },
		{ EnemiesV3_2.TransmutedSkull1, new[] { "Slowly chases the player" } },
		{ EnemiesV3_2.TransmutedSkull2, new[] { "Repeatedly moves towards a random position for between 1.6 and 2.5 seconds" } },
		{ EnemiesV3_2.TransmutedSkull3, new[] { "Chases the player fast" } },
		{ EnemiesV3_2.TransmutedSkull4, new[] { "Chases the player fast" } },
		{ EnemiesV3_2.SpiderEgg1, new[] { "Hatches into 5 Spiderlings after 10 seconds" } },
		{ EnemiesV3_2.SpiderEgg2, new[] { "Hatches into 5 Spiderlings after 10 seconds" } },
		{ EnemiesV3_2.Spiderling, new[] { "Darts towards the player in bursts with random offsets" } },
		{ EnemiesV3_2.TheOrb, new[] { "Activates 10 seconds after Leviathan's death", "Behaves like an eyeball, will look at the player, then attract and transmute all skulls by beckoning every 2.5333 seconds", "Becomes stunned under constant fire, cannot look or attract skulls while stunned" } },
	};
