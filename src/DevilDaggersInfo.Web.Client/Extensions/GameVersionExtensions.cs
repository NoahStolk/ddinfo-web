...
public static class GameVersionExtensions
{
	...
	public static ApiSpec.Main.WorldRecords.GameVersion ToMainApi(this GameVersion gameVersion)
	{
	...
	public static GameVersion ToCore(this ApiSpec.Main.WorldRecords.GameVersion gameVersion)
	{
		return gameVersion switch
		{
