...
internal static class CustomLeaderboardCriteriaOperatorExtensions
{
	public static CustomLeaderboardCriteriaOperator ToCore(this AdminApi.CustomLeaderboardCriteriaOperator criteriaOperator)
	{
	...
	public static CustomLeaderboardCriteriaOperator ToCore(this MainApi.CustomLeaderboardCriteriaOperator criteriaOperator)
	{
		return criteriaOperator switch
		{
	...
	public static string GetColor(this CustomLeaderboardCriteriaOperator criteriaOperator)
	{
		return criteriaOperator switch
		{
