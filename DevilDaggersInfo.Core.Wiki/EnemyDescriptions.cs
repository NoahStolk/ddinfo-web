...
public static class EnemyDescriptions
{
	private static readonly Dictionary<Enemy, string[]> _enemyDescriptions = new()
	{
		...
		{ EnemiesV3_2.Centipede, new[] { "Emerges approximately 3 seconds after its spawn, starts flying idly for a while, then starts chasing the player", "Regularly dives down and moves underground for a while" } },
