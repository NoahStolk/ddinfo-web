...
{
	public static void AddOrModifyQueryParameters(this NavigationManager navigationManager, string key, object value)
		=> AddOrModifyQueryParameters(navigationManager, new KeyValuePair<string, object>(key, value));
