...
namespace DevilDaggersWebsite.Pages.API
{
	...
	{
		public FileResult OnGet(int? deathType = null, string gameVersion = GameInfo.DEFAULT_GAME_VERSION, bool formatted = false)
		{
			...
			return JsonFile(deathType.HasValue ? new List<Death> { GameInfo.GetDeathFromDeathType(deathType.Value, version) } : GameInfo.GetEntities<Death>(version), formatted ? Formatting.Indented : Formatting.None);
		}
	}
}