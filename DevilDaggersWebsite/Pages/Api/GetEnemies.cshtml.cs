...
namespace DevilDaggersWebsite.Pages.Api
{
	...
	{
		public ActionResult OnGet(string enemyName = "", string gameVersion = GameInfo.DefaultGameVersion, bool formatted = false) => JsonFile(ApiFunctions.GetEnemies(enemyName, gameVersion), formatted ? Formatting.Indented : Formatting.None);
	}
}