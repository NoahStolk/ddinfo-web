...
namespace DevilDaggersWebsite.Pages.Api
{
	...
	{
		public FileResult OnGet(int? deathType = null, string gameVersion = GameInfo.DefaultGameVersion, bool formatted = false) => JsonFile(ApiFunctions.GetDeaths(deathType, gameVersion), formatted ? Formatting.Indented : Formatting.None);
	}
}