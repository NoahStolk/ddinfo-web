...
namespace DevilDaggersWebsite.Code.Donations
{
	public static class DonationList
	{
		...
		{
			new Donation(137044, 100, "EUR", 100, new DateTime()),
			new Donation(105315, 1000, "EUR", 1000, new DateTime()),
			new Donation(105315, 1, "EUR", 1, new DateTime(2018, 2, 20)),
			new Donation(94857, 77, "EUR", 39, new DateTime()),
			new Donation(142939, 1200, "EUR", 1200, new DateTime()),
			...
			new Donation(113530, 500, "USD", 450, new DateTime(2018, 2, 28)), // conv not sure
			new Donation(113530, 500, "USD", 450, new DateTime(2018, 9, 4)), // conv not sure
			new Donation(113530, 500, "USD", 450, new DateTime(2018, 12, 8)), // conv not sure
			new Donation(148518, 500, "USD", 450, new DateTime(2018, 3, 27)), // conv not sure
			...
			new Donation(172395, 500, "USD", 450, new DateTime(2018, 9, 21)), // conv not sure
			...
			new Donation(146931, 2500, "USD", 2000, new DateTime(2019, 6, 6)), // conv not sure
			new Donation(146931, 2500, "USD", 2000, new DateTime(2019, 9, 11)), // conv not sure
			...
			new Donation(0, 666, "GBP", 728, new DateTime(2020, 3, 12)), // id not sure
		};
